...
## [2.11.0](https://github.com/g-duval/clowder-quarkus-config-source/compare/v2.10.0...v2.11.0) (2026-06-09)


### Features

* [RHCLOUD-30340] add Kafka SSL config with a certificate provide… ([#211](https://github.com/g-duval/clowder-quarkus-config-source/issues/211)) ([6922171](https://github.com/g-duval/clowder-quarkus-config-source/commit/69221710f4a9a640093690f3ef09cbb8168ec51f))
* Be able to expose Kafka config keys from ClowderConfigSource ([#198](https://github.com/g-duval/clowder-quarkus-config-source/issues/198)) ([35f5e7c](https://github.com/g-duval/clowder-quarkus-config-source/commit/35f5e7cdb425b1b245226a821fa3a088f5168bbf))
* Bump Java from 11 to 17 ([#159](https://github.com/g-duval/clowder-quarkus-config-source/issues/159)) ([eb65d59](https://github.com/g-duval/clowder-quarkus-config-source/commit/eb65d5953ddeb52336ed620d6ac45f7e6af1d875))
* Bump Quarkus to 3.7.4 ([#227](https://github.com/g-duval/clowder-quarkus-config-source/issues/227)) ([ff3495a](https://github.com/g-duval/clowder-quarkus-config-source/commit/ff3495a16682b25330617ac9a2586b5cc08797eb))
* Fix project version and trigger a new release ([#153](https://github.com/g-duval/clowder-quarkus-config-source/issues/153)) ([fe5a37e](https://github.com/g-duval/clowder-quarkus-config-source/commit/fe5a37e04a2c06d332ab2622c2e520a8de76e12d))
* Release clowder-quarkus-config-source ([#341](https://github.com/g-duval/clowder-quarkus-config-source/issues/341)) ([ca8faef](https://github.com/g-duval/clowder-quarkus-config-source/commit/ca8faef1ebc63ab3e31869fab7da511bee329125))
* release clowder-quarkus-config-source ([#365](https://github.com/g-duval/clowder-quarkus-config-source/issues/365)) ([7fc96bd](https://github.com/g-duval/clowder-quarkus-config-source/commit/7fc96bd32c42f455f4e375de17e1bc7d29c0342a))
* release clowder-quarkus-config-source ([#374](https://github.com/g-duval/clowder-quarkus-config-source/issues/374)) ([c4f67d3](https://github.com/g-duval/clowder-quarkus-config-source/commit/c4f67d34aefa44148561a6deb62287526b22224e))
* release QuarkusRedisClowderPropertyHandler ([#293](https://github.com/g-duval/clowder-quarkus-config-source/issues/293)) ([901727c](https://github.com/g-duval/clowder-quarkus-config-source/commit/901727c8bccb094e71b4944d25022d065b91cb94))
* Resolve computed properties for Kafka topics ([c485a66](https://github.com/g-duval/clowder-quarkus-config-source/commit/c485a6620ac559303ced114c74fb59dd036177e3))
* Start release ([#329](https://github.com/g-duval/clowder-quarkus-config-source/issues/329)) ([ead229f](https://github.com/g-duval/clowder-quarkus-config-source/commit/ead229f3ec4cb6f23f4b12e9e3afcc10cb1e9ba2))
* support Camel Kafka props ([#96](https://github.com/g-duval/clowder-quarkus-config-source/issues/96)) ([3fc6e40](https://github.com/g-duval/clowder-quarkus-config-source/commit/3fc6e40fc919a09017112605fea85368f5658f78))
* Trigger a new release ([#241](https://github.com/g-duval/clowder-quarkus-config-source/issues/241)) ([3c71b99](https://github.com/g-duval/clowder-quarkus-config-source/commit/3c71b99f7404f72e236ed89fbb1637319b1155c0))


### Bug Fixes

* Add nexus-staging-maven-plugin ([#156](https://github.com/g-duval/clowder-quarkus-config-source/issues/156)) ([4b0dde5](https://github.com/g-duval/clowder-quarkus-config-source/commit/4b0dde5b63b4de87a475503a3ec0b5cc6d5c2f15))
* add PGP signature ([#332](https://github.com/g-duval/clowder-quarkus-config-source/issues/332)) ([4797f27](https://github.com/g-duval/clowder-quarkus-config-source/commit/4797f27f9fa14287b16e47e13c0874cd7b28d04d))
* artefact version ([#200](https://github.com/g-duval/clowder-quarkus-config-source/issues/200)) ([56b0ef2](https://github.com/g-duval/clowder-quarkus-config-source/commit/56b0ef23353bff6519b1afec7bde862db69fd72a))
* bump release ([#307](https://github.com/g-duval/clowder-quarkus-config-source/issues/307)) ([46b203e](https://github.com/g-duval/clowder-quarkus-config-source/commit/46b203e763b9a8f1b08f393ab943c324354f0faf))
* Deploy sources and javadoc ([#160](https://github.com/g-duval/clowder-quarkus-config-source/issues/160)) ([e9408d1](https://github.com/g-duval/clowder-quarkus-config-source/commit/e9408d1f1fffd71c4d6cf8cddad50c9a47301dd3))
* **logging:** only look for type null ([#87](https://github.com/g-duval/clowder-quarkus-config-source/issues/87)) ([0eba62c](https://github.com/g-duval/clowder-quarkus-config-source/commit/0eba62c6e484251eabcc1c42de61a52cfdd51f1e))
* null pointer exception when attempting to read a system property ([#245](https://github.com/g-duval/clowder-quarkus-config-source/issues/245)) ([e5191e4](https://github.com/g-duval/clowder-quarkus-config-source/commit/e5191e453476374e9d0624bf277b4e163c908348))
* Release clowder-quarkus-config-source ([#344](https://github.com/g-duval/clowder-quarkus-config-source/issues/344)) ([ea52c7f](https://github.com/g-duval/clowder-quarkus-config-source/commit/ea52c7fc91049ac3cc68ada087fe79c969c32105))
* restart release 2.1.0 ([#204](https://github.com/g-duval/clowder-quarkus-config-source/issues/204)) ([a0d051e](https://github.com/g-duval/clowder-quarkus-config-source/commit/a0d051e64b8b335293806e15e52cb7fe461363e0))
* RHCLOUD-28459 Fix Unleash API URL ([#230](https://github.com/g-duval/clowder-quarkus-config-source/issues/230)) ([bacf632](https://github.com/g-duval/clowder-quarkus-config-source/commit/bacf632827838557937fb5d7f3a7546d8ad97318))
* use rediss:// for quarkus.redis.hosts if password provided ([#303](https://github.com/g-duval/clowder-quarkus-config-source/issues/303)) ([d464b95](https://github.com/g-duval/clowder-quarkus-config-source/commit/d464b95e91522f5e9b764704e0291361c30f761b))
